...
- Extracts: **Condition, Medication, Diet, Monitoring, and Warning signs.**
...
- Detects patient risk level in real time:
  ...
  - 🟡 **Medium Risk**
  - 🔴 **High Risk**
- Flags emergency symptoms like chest pain, dizziness, or severe BP fluctuations.
...
## 📸 Product Experience
- **Doctor Dashboard:** Patient overview, AI instructions, and risk scoring.
- **Admin Analytics:** Total patients, risk distribution, and hospital insights.
- **AI Assistant:** ChatGPT-style medical interface for patient guidance.
...
## ⚠️ Disclaimer
MedAI is a proof-of-concept healthcare AI system for educational and demonstration purposes. It is not a medical device and should not be used for real diagnosis or emergency treatment. Always consult licensed healthcare professionals.
